...
class BasicSystem extends ParticleSystem {
  ...
  static desc = "Order to Chaos"; // Ignore the Glitch parse error
...
class BasicParticle extends Particle {
  ...
  calculateForces(p, dt) {
   ...
   // We can attract it to the center
    ...
    let top_left = new Vector2D(0, 0)
    this.attractionForce = this.pos.getForceTowardsPoint(top_left, 1, { falloff:1 } )
